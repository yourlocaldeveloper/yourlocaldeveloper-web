  ...
  return (
    <div className={styles.comingSoonView}>
      <div className={styles.comingSoonContainer}>
        <Heading isBold>Aaron Yates</Heading>
        ...
        />
        <Heading as={'h6'}>
          The website is getting the final touches. In the meantime view out my
          other links:
        </Heading>
        <div className={styles.iconContainer}>
          <Link href="https://github.com/yourlocaldeveloper" target="_blank">
            <svg
          ...
          <Link
            href="https://www.linkedin.com/in/aaron-yates-27007316b/"
            target="_blank"
          >
            <svg
              className={styles.icons}
